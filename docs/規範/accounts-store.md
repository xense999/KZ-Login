...
- 動作：`addAccount`、`updateAlias`、`updateGameName`、`removeAccount`、`moveAccount`、`moveGameAccount`、`invalidateToken`、`updateToken(accountId, login)`、`markUsed`。
